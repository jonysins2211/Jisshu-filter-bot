...
API_ID = int(environ.get("API_ID", "22037991"))
API_HASH = environ.get("API_HASH", "f88fd01b091240edbb9a06a6f67fb3b5")
...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "949657126").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Mladminbot"
...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1001176901973 -1002096410592").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1001622914589"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002237171878"))
...
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://tonymawa:xKZnH1Kpxs1g5XkC@cluster0.5sd3s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "jisshu")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002077293491"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002134871596")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002549330105"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+7hhFYFo61m5hNzU9")
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/a319f6b9ce3b993c6e22f.jpg ",
    )
).split()
...
if "DYNO" in environ:
    ...
    ON_HEROKU = False
URL = environ.get("FQDN", "https://a-loki-bot1-8ef8e94f5b66.herokuapp.com/")
